<?php
/**
 * MoodifyMe - Vercel Production Configuration
 * Configuration for Vercel deployment with PlanetScale MySQL
 */
...
define('APP_URL', $_ENV['APP_URL'] ?? 'https://your-app.vercel.app');
...
$allowed_origins = [
    ...
    $_ENV['APP_URL'] ?? 'https://your-app.vercel.app'
];

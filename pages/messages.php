    ...
    foreach ($conversations as $conv) {
        if ($conv['id'] == $selectedConversationId) {
            ...
            $otherUser = [
                ...
                'profile_image' => $conv['other_profile_image']
            ];
            break;
        }
    }
...
if (!$selectedConversationId && !empty($conversations)) {
    ...
    $otherUser = [
        ...
        'profile_image' => $conversations[0]['other_profile_image']
    ];
}
                        ...
                        <div class="list-group list-group-flush">
                            <?php foreach ($conversations as $conv): ?>
                                <a href="?conversation=<?php echo $conv['id']; ?>" 
                                   class="list-group-item list-group-item-action <?php echo $selectedConversationId == $conv['id'] ? 'active' : ''; ?>">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex align-items-center">
                                ...
                                <?php if ($otherUser['profile_image']): ?>
                                    <img src="<?php echo APP_URL . '/' . $otherUser['profile_image']; ?>" 
...
<style>
/* Reuse chat styles from community chat */
